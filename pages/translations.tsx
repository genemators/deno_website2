...
function TranslationsPage(): React.ReactElement {
  return (
    <>
      <Head>
        <title>Tarjimalar | Deno</title>
      </Head>
      <CookieBanner />
      <Header />
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 md:px-8 mt-8 mb-24">
        <div className="max-w-screen-lg mx-auto">
          <h4 className="text-4xl font-bold tracking-tight">Tarjimalar</h4>
          <p className="mt-4 text-lg">
            Deno dokumentatsiyalari quyidagi tillarda mavjud. Sizda ham tarjima
            qismlari bormi?{" "}
            <a
