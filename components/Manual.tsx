              ...
              <div className="flex-1 flex">
                <div className="w-full flex justify-between h-full">
                  ...
                  >
                    ...
                    <div className="pl-6">
                      <span className="inline sm:hidden">Dokumentatsiya qidirish</span>
                      <span className="hidden sm:inline">
                        Dokumentatsiya qidirish (ishlash uchun <InlineCode>/</InlineCode> tugmasini
                        bosing)
                      </span>
                    </div>
                  </button>
            ...
            <div className="h-16 bg-white shadow hidden md:block">
              <div className="max-w-screen-md mx-auto px-12 w-full flex justify-between h-full">
                ...
                >
                  ...
                  <div className="pl-6">
                    Dokumentatsiya qidirish (ishlash uchun <InlineCode>/</InlineCode> tugmasini bosing)
                  </div>
                </button>
              </div>
            </div>
                ...
                <>
                  ...
                  >
                    ...
                    <svg
                      ...
                      viewBox="0 0 24 24"
                    >
                      <title>GitHub o'zgarish kiritish</title>
                      <path
                        fillRule="evenodd"
