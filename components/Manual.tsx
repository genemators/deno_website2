  ...
  useEffect(() => {
    ...
    fetch(sourceURL)
      .then((res) => {
        if (res.status !== 200) {
          throw Error(
            `Qo'llanmani yuklaguncha (${res.status}) xatolik yuz berdi.`
          );
        }
        return res.text();
      })
      ...
      .catch((e) => {
        ...
        setContent(
          "# 404 - Noma'lum\nAna bo'masam, web sahifa mavjud emas."
        );
      });
  }, [sourceURL]);
              ...
              <div className="flex-1 flex">
                <div className="w-full flex justify-between h-full">
                  ...
                  >
                    ...
                    <div className="pl-6">
                      <span className="inline sm:hidden">Qo'llanma qidirish</span>
                      <span className="hidden sm:inline">
                        Qo'llanma qidirish (qidirish uchun <InlineCode>/</InlineCode> tugmasini
                        bosign)
                      </span>
                    </div>
                  </button>
            ...
            <div className="h-16 bg-white shadow hidden md:block">
              <div className="max-w-screen-md mx-auto px-12 w-full flex justify-between h-full">
                ...
                >
                  ...
                  <div className="pl-6">
                    Qo'llanma qidirish (qidirish uchun <InlineCode>/</InlineCode> tugmasini bosing)
                  </div>
                </button>
              </div>
            </div>
                ...
                <>
                  ...
                  >
                    ...
                    <svg
                      ...
                      viewBox="0 0 24 24"
                    >
                      <title>GitHub da o'zgartirish kiriting</title>
                      <path
                        fillRule="evenodd"
